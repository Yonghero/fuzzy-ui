import { w as withInstall, g as getRandomColor, _ as _extends, a as _objectSpread2 } from '../color-b4a7db3b.js';
import ElementPlus, { ElButton, ElInput, ElIcon, ElCard, ElSwitch, ElPopover } from 'element-plus';
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [createVNode(unref(ElInput), mergeProps(_ctx.$attrs, {
        ...
        "default": withCtx(function () {
          return [_hoisted_2$2, (openBlock(true), createElementBlock(Fragment, null, renderList(props.filterList, function (item, index) {
