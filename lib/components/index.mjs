    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$l, [createVNode(unref(ElDialog), mergeProps(_ctx.$attrs, {
        ...
        "default": withCtx(function () {
          ...
          }, null, 8 /* PROPS */, ["dialogConfig"])) : createCommentVNode("v-if", true)];
        }),
        _: 3 /* FORWARDED */
...
function getColumns(template) {
  var _getColumn = function _getColumn(scope, tmpl) {
    if (tmpl.render) {
      ...
      if (renderTmpl !== null && renderTmpl !== void 0 && renderTmpl.setup) return createVNode(renderTmpl, null, null);
      return renderTmpl;
    }
    if (tmpl.type) {
      // eslint-disable-next-line no-underscore-dangle
