...
var _hoisted_6$6 = [_hoisted_2$j, _hoisted_3$d, _hoisted_4$c, _hoisted_5$8];
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$r, [!props.virtual && props.virtual !== '' ? (openBlock(), createBlock(unref(ElSelect), mergeProps({
        ...
        name: "prefix",
        fn: withCtx(function () {
          return [createElementVNode("div", _hoisted_2$h, [createElementVNode("div", _hoisted_3$c, [!getAccessIcon.value ? (openBlock(), createBlock(unref(ElIcon), {
            key: 0
          }, {
            "default": withCtx(function () {
              return [createVNode(unref(lock_default))];
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createBlock(_component_el_popover, {
        ...
        "default": withCtx(function () {
          return [createElementVNode("div", _hoisted_1$p, [createElementVNode("header", null, [_hoisted_2$g, createElementVNode("div", {
            "class": "close-icon",
            onClick: cancel
...
var script$q = /*#__PURE__*/Object.assign({
  ...
  setup: function setup(__props) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$n, [parseInt(props.type) === 1 ? (openBlock(), createElementBlock("div", _hoisted_2$e, [createVNode(_component_el_skeleton, mergeProps({
        style: {
          "width": "100%",
          "text-align": "left"
        }
...
var script$a = {
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      var _component_el_icon = resolveComponent("el-icon");
      return openBlock(), createElementBlock("div", _hoisted_1$8, [createElementVNode("div", _hoisted_2$6, [createElementVNode("div", _hoisted_3$4, " 可选择属性 · " + toDisplayString(allTmpl.value.length), 1 /* TEXT */), createElementVNode("div", _hoisted_4$3, [createVNode(unref(FYInput), {
