import { w as withInstall, g as getRandomColor, _ as _extends, a as _objectSpread2 } from '../color-12995c93.js';
...
var script$6 = /*#__PURE__*/Object.assign({
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [createVNode(unref(ElInput), mergeProps(_ctx.$attrs, {
      ...
      return openBlock(), createBlock(_component_el_cascader, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
        "default": withCtx(function (_ref) {
          ...
          return [createCommentVNode("   外部插槽传入    "), hasDefaultSlot.value ? renderSlot(_ctx.$slots, "default", {
            ...
            key: 1
          }, [createCommentVNode("   外部插槽不传入    "), createElementVNode("div", _hoisted_1$3, [createCommentVNode("   data item 是否传入icon    "), data.icon ? (openBlock(), createBlock(resolveDynamicComponent(data.icon), {
            key: 0
...
var script$3 = /*#__PURE__*/Object.assign({
  ...
  setup: function setup(__props) {
    return function (_ctx, _cache) {
      ...
      return openBlock(), createBlock(_component_el_empty, mergeProps({
        image: unref(NoResult)
