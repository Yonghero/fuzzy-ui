...
var tool = require('../tool-13c88a58.js');
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$r, [!props.virtual && props.virtual !== '' ? (vue.openBlock(), vue.createBlock(vue.unref(ElementPlus.ElSelect), vue.mergeProps({
        ...
        name: "prefix",
        fn: vue.withCtx(function () {
          return [vue.createElementVNode("div", _hoisted_2$h, [vue.createElementVNode("div", _hoisted_3$c, [!getAccessIcon.value ? (vue.openBlock(), vue.createBlock(vue.unref(ElementPlus.ElIcon), {
            key: 0
          }, {
            "default": vue.withCtx(function () {
              return [vue.createVNode(vue.unref(lock_default))];
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return vue.openBlock(), vue.createBlock(_component_el_popover, {
        ...
        "default": vue.withCtx(function () {
          return [vue.createElementVNode("div", _hoisted_1$p, [vue.createElementVNode("header", null, [_hoisted_2$g, vue.createElementVNode("div", {
            "class": "close-icon",
            onClick: cancel
...
var script$q = /*#__PURE__*/Object.assign({
  ...
  setup: function setup(__props) {
    ...
    return function (_ctx, _cache) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$n, [parseInt(props.type) === 1 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$e, [vue.createVNode(_component_el_skeleton, vue.mergeProps({
        style: {
          "width": "100%",
          "text-align": "left"
        }
