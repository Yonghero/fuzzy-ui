...
var tool = require('../tool-40d5deb3.js');
...
var script$a = {
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      var _component_el_icon = vue.resolveComponent("el-icon");
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$8, [vue.createElementVNode("div", _hoisted_2$6, [vue.createElementVNode("div", _hoisted_3$4, " 可选择属性 · " + vue.toDisplayString(filterLeftTmpl.value.length), 1 /* TEXT */), vue.createElementVNode("div", _hoisted_4$3, [vue.createVNode(vue.unref(FYInput), {
