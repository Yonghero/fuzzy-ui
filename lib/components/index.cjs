...
var color = require('../color-0b990b74.js');
...
var script$6 = /*#__PURE__*/Object.assign({
  ...
  setup: function setup(__props, _ref) {
    ...
    return function (_ctx, _cache) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$4, [vue.createVNode(vue.unref(ElementPlus.ElInput), vue.mergeProps(_ctx.$attrs, {
      ...
      return vue.openBlock(), vue.createBlock(_component_el_cascader, vue.normalizeProps(vue.guardReactiveProps(_ctx.$attrs)), {
        "default": vue.withCtx(function (_ref) {
          ...
          return [vue.createCommentVNode("   外部插槽传入    "), hasDefaultSlot.value ? vue.renderSlot(_ctx.$slots, "default", {
            ...
            key: 1
          }, [vue.createCommentVNode("   外部插槽不传入    "), vue.createElementVNode("div", _hoisted_1$3, [vue.createCommentVNode("   data item 是否传入icon    "), data.icon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(data.icon), {
            key: 0
