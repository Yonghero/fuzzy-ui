...
document.addEventListener('mouseup', function (e) {
  var _iterator = color._createForOfIteratorHelper(nodeList.values()),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var handlers = _step.value;
      var _iterator2 = color._createForOfIteratorHelper(handlers),
        _step2;
      try {
...
exports.getRandomColor = color.getRandomColor;
exports.withInstall = color.withInstall;
